...
MpvHandle::OptionList MpvHandle::defaultOptions()
{
    return {
        ...
        { QStringLiteral("load-console"), QStringLiteral("no") },
        { QStringLiteral("load-auto-profiles"), QStringLiteral("no") },
        { QStringLiteral("load-select"), QStringLiteral("no") },
        { QStringLiteral("load-commands"), QStringLiteral("no") },
        { QStringLiteral("load-positioning"), QStringLiteral("no") },
        { QStringLiteral("load-context-menu"), QStringLiteral("no") },
